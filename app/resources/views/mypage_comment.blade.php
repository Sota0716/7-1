...
<!-- コメントした投稿 などフィルター -->
    <div class="w-100 row row-cols-3 border-top border-bottom share-mypage-filter">
        <div class="col share-flex-column-center share-mypage-box ">
            <a class="bg-primary" href=""><img src="{{ asset('imges/icons8-コメント-100.png') }}" alt=""></a>
        </div>
        <div class="col share-flex-column-center share-mypage-box">
            ...
            <div class="w-75 share-timeline-post-box row border border-1 rounded share-bg my-4 shadow">
                ...
                <div class="col-sm">
                    <div class="d-flex align-items-center share-height-90">
                        <!-- アイコン -->                                                                                
                            <a class="rounded-circle share-post-icon d-flex align-items-center justify-content-center" href="{{ route( 'users.page',[ 'post' => $post['post']['id'] ]) }}">
                                <img src="{{ asset($post['post']['user']['image']) }}" alt="" onerror="this.src='{{asset('imges/icons8-ユーザー-96.png')}}'">
                            </a>                                                                        
                        <!-- 留学地域  -->
                    ...
                    <div class="mt-5 share-post-img">
                        <img class="share-box52" src="{{ asset($post['post']['image']) }}" onerror="this.src='{{asset('imges/hardwood-1851074_1280.jpg')}}'">
                    </div>
                </div>
                <!-- 投稿右部分 -->
                <div  class="col-sm h-100">
                    ...
                    <a  class="btn btn-primary my-2" href="{{ route('comment', ['post' => $post['post']['id']]) }}">
                    コメント表示
                    </a>
                </div>
                <!-- モーダル -->
